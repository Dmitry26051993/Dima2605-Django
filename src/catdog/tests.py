...
class TestCatDogView(TestCase):
    ...
    def test_post_cat(self):
        ...
        self.assertEqual(len(self.client.session['data_for_session'].keys()), 5)
        self.assertEqual(AnimalImage.objects.count(), 10)
    ...
    def test_save_catdog(self):
        ...
        self.assertTemplateUsed(responce, template_name='petsave.html')